...
@Data
public class OssImplApplyDTO implements Serializable {
    ...
    /** 评测指标数据(JSON) - 从oss_impl_apply_supl表获取 */
    private String evalIndicatorsJson;

    /** 评测结果数据(JSON) - 从oss_impl_apply_supl表获取 */
